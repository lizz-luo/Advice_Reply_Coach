...
HELP_HINTS = {
    ...
    "caring_tone":            "kind, warm, friendly words",
    ...
    "spelling_punctuation":   "check spelling and punctuation marks",
    "power_words":            "use strong, expressive words",
...
HELP_OPTIONS = {
    "content": [
        {"value": "address_problem",  "label": "🎯 Address the problem — Did I talk about the reader's problem?"},
        {"value": "two_advice",       "label": "💡 Two or more tips — Did I give at least 2 pieces of advice?"},
        {"value": "explain_advice",   "label": "🔍 Explain your advice — Did I explain how each tip can help?"},
        {"value": "caring_tone",      "label": "❤️ Caring tone — Did I use kind, warm, friendly words?"},
    ],
    "language": [
        {"value": "modal_verbs",           "label": "💪 Modal verbs — Did I use modal verbs correctly? (e.g. should, could, might)"},
        {"value": "conditional_sentences", "label": "🔄 Conditional sentences — Did I use conditional sentences? (e.g. If you…, you could…)"},
        {"value": "empathy_phrases",       "label": "🤗 Empathy phrases — Did I use phrases to show I understand? (e.g. I understand how you feel)"},
        {"value": "linking_words",         "label": "🔗 Linking words — Did I use words to join my ideas? (e.g. firstly, also, moreover)"},
        {"value": "spelling_punctuation",  "label": "✏️ Spelling & punctuation — Are my spelling and punctuation correct? (e.g. ! ? , : .)"},
        {"value": "power_words",          "label": "⚡ Power words — Did I use strong, expressive words instead of basic ones? (e.g. sad → upset, good → wonderful, happy → delighted)"},
    ],
    "organisation": [
        {"value": "greeting_signoff",    "label": "👋 Greeting & sign-off — Did I include a proper greeting and sign-off? (e.g. Dear… / Best wishes)"},
        {"value": "acknowledge_problem", "label": "📨 Acknowledge the problem — Did I show I understand the problem first?"},
        {"value": "separate_paragraphs", "label": "📄 Separate paragraphs — Did I put each idea in its own paragraph?"},
        {"value": "encouraging_closing", "label": "🌟 Encouraging closing — Did I end with hope and support?"},
    ],
}
...
HELP_DESC_MAP = {
    ...
    "caring_tone":            "whether the student used kind, warm, and friendly words throughout",
    ...
    "power_words":            "whether the student used strong, expressive words instead of very basic ones (e.g. sad → upset, good → wonderful, happy → delighted)",
    "greeting_signoff":       "whether the student included a proper greeting and sign-off",
    "acknowledge_problem":    "whether the student showed understanding of the problem first",
    "separate_paragraphs":    "whether the student put each idea in its own paragraph",
    "encouraging_closing":    "whether the student ended with hope and support",
}
